...
Route::get(config('resource-viewer.route') . '/{resource}/{id}/pivot/{pivot}/{pivotId}', 'ResourceController@show')
    ->name('resource.pivot.show');

Route::get(config('resource-viewer.route') . '/{resource}/{id}/pivot/{pivot}/{pivotId}/edit', 'ResourceController@edit')
    ->name('resource.pivot.edit');

Route::put(config('resource-viewer.route') . '/{resource}/{id}/pivot/{pivot}/{pivotId}', 'ResourceController@update')
    ->name('resource.pivot.update');

Route::post(config('resource-viewer.route') . '/{resource}/{id}/pivot/{pivot}', 'ResourceController@assign')
